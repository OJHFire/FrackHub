...
public class Oracle_Database implements ActionListener {
		...
		if (e.getSource() == registerButton) {
			try {
				...
				PreparedStatement Pstatement = connection
						.prepareStatement("insert into FrackHub_Test(Id, Name, Surname, Address, Contact_Number, Email, Password) values(seq_person.nextval,?,?,?,?,?,?)");
