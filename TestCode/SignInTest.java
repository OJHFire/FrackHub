...
class SignInTest {
	...
	void testSaveCust() {
			...
			try {
			       ...
			       ResultSet rs = stmt.executeQuery("SELECT COUNT(*) AS count FROM Frackhub_Test WHERE email = 'RebelYell@hotmail.com'");  
			       ...
			       stmt2.executeUpdate("DELETE FROM Frackhub_Test WHERE email = 'RebelYell@hotmail.com'");			       
	...
	void testCustSignIn() {
		...
		try {
		       ...
		       stmt.executeUpdate("DELETE FROM Frackhub_Test WHERE email = 'RebelYell@hotmail.com'");			       
