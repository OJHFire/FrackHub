...
class BookingClassTest {
	...
	void testSaveBooking() {
		...
		try {
		       ...
		       stmt2.executeUpdate("DELETE FROM bookingsv2 WHERE itemid = 999999");		
		       stmt3.executeUpdate("DELETE FROM itemsv2 WHERE id = 999999");
	...
	void testCheckBooking() {
		...
		try {
		       ...
		       stmt1.executeUpdate("DELETE FROM bookingsv2 WHERE itemid = 999999");		
		       stmt2.executeUpdate("DELETE FROM itemsv2 WHERE id = 999999");
